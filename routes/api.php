...
Route::get('/teams/{teamId}/join/{teamInviteLink}', [TeamController::class, 'joinTeamViaLink']);
...
Route::middleware(['auth:sanctum', 'verified'])->group(function(){
    ...
    Route::put('/debates/moderate-suggested-debate/{suggestedDebateId}', [DebateController::class, 'moderateSuggestedDebate']); // Moderate Suggested Debate
